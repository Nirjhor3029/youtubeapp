                ...
                <div class="box box-primary">
                    <div class="box-body" style="margin-top:2rem;">
                        @if(!isset($vdo_category))
                            <form action="{{route('addCategorySubmit')}}" method="post" class="form-horizontal"
                        ...
                        @else
                            <form action="{{route('editVideoCategorySubmit',$vdo_category->id)}}" method="post" class="form-horizontal"
                                  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row form-group">
                                    <div class="col-sm-2">
